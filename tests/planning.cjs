...
(async()=>{
 ...
 await page.click('#menuOpen');await page.click('#drawer [data-route="appSettings"]');await page.click('#settingsMenu [data-route="planning"]');
