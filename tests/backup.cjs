...
module.exports=async(browser,url)=>{
 ...
 assert.match(await (await page.request.get(url+'/icons/info.svg')).text(),/cy="8.2"/,'Supplied info dot retained');assert.equal(await page.evaluate(()=>infoIcon.includes('data-icon="info"')),true);
