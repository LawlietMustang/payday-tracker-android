...
android {
    ...
    compileSdk = 35
    defaultConfig { applicationId = "com.paydaytracker.app"; minSdk = 26; targetSdk = 35; versionCode = 26; versionName = "2.3.1"; testInstrumentationRunner = "com.paydaytracker.app.DeviceSmoke" }
    signingConfigs {
        create("permanent") {
