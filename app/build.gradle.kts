...
android {
    ...
    compileSdk = 35
    defaultConfig { applicationId = "com.paydaytracker.app"; minSdk = 26; targetSdk = 35; versionCode = 34; versionName = "2.4.5"; testInstrumentationRunner = "com.paydaytracker.app.DeviceSmoke" }
    signingConfigs {
        create("permanent") {
